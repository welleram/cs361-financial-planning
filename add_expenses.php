  ...
  <!-- Full Width Image Header with Logo -->
    ...
    <header class="image-bg-fluid-height">
        <img class="bg" src="3.png"  height="280" alt="">
						...
						<legend id="add_account_title"> <h1> Add Expense </h1></legend> 
 
	<div>
		<form name="addIncome" method="post" action="add_expense_database.php" class="form-horizontal">
		
		<fieldset>
		
		<!-- we need to choose an account where the money will go 1 -->
				<p>Chose account where expense will be charged: <select name="account">
				<?php
...
<div class="form-group">
  <label class="col-md-4 control-label" for="selectbasic">Expense Type</label>
  <div class="col-md-4">
    <select id="select_expense_type" name="expenseType" class="form-control">
      <option value="" disabled selected>Please select...</option>
      <option value="1">Personal Expenses</option>
      <option value="2">Car Expenses</option>
      <option value="3">House Expenses</option>
      <option value="4">Financial Expenses</option>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="submit" name="add" class="btn btn-primary" value = "Add Expense">Add Expense</button>
  </div>
</div>
